  ...
  >
    ...
    >
      <template #label>
        <div
          :class="classWithSize"
          class="bg-muted rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:bg-white after:border-muted after:border after:rounded-full after:transition-all peer-checked:bg-primary"
        ></div>
        <span :class="labelClassWithSize" class="ml-3 text-primary">{{
          label
        }}</span>
      </template>
    </InputField>
